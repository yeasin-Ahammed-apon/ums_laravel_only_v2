                ...
                <form action="{{ route('superAdmin.notification.cod') }}" method="GET">
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <div class="input-group-append">
                            ...
                            <a href="{{ route('superAdmin.notification.cod') }}"class="btn btn-sm mt-1 mb-1 btn-default  ml-2">All
                                Notification</a>
                            <a
                                href="{{ route('superAdmin.notification.cod', ['seen' => 0]) }}"class="btn btn-sm mt-1 mb-1 btn-success  ml-2">All
                                Unseen Notification</a>
                            <a onclick="disableButton(this)"
                                href="{{ route('superAdmin.notification.cod', ['seen' => 1]) }}"class="btn btn-sm mt-1 mb-1 btn-secondary  ml-2">All
                                Seen Notification</a>
                        </div>
...
@endsection
@section('scripts')
    @include('parts.multiple_check_js',['multiple_check_url'=>'superAdmin.notification.cod'])
    @include('parts.page_number_set_js',['page_number_url'=>'superAdmin.notification.cod'])
@endsection
