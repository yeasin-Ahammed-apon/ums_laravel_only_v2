...
@section('content')
    ...
    <div class="card">
        <form action="{{ route('superAdmin.account.update', $data->user_id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('superAdmin.account.show', $data->id) }}" class="btn btn-sm mt-1 mb-1 btn-success"><i class="fa fa-eye" aria-hidden="true"></i> View</a>
            </div>
        </form>
    </div>
    <!-- /.card -->
