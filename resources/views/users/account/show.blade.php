        ...
        <div class="card bg-light d-flex flex-fill">
          ...
          <div class="card-footer">
            <div class="text-right">
                <a href="{{ route(Auth::user()->role->name.'.account.edit', $data->id) }}" class="btn btn-sm mt-1 mb-1 btn-primary"><i class="fa fa-cogs" aria-hidden="true"></i> Edit</a>
