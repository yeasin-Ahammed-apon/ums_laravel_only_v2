                ...
                <form action="{{ route('admin.cod.index') }}" method="GET">
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <div class="input-group-append">
                            ...
                            <a href="{{ route('admin.cod.create') }}"class="btn btn-primary  ml-2">+ Add Admins</a>
                            <a href="{{ route('admin.cod.index') }}"class="btn btn-default  ml-2">All Admins</a>
                            <a href="{{ route('admin.cod.index', ['status' => 1]) }}"class="btn btn-success mr-2 ml-2">Active
                                Admins</a>
                            <a href="{{ route('admin.cod.index', ['status' => 0]) }}" class="btn btn-warning">Deactive
                                Admins</a>
                        </div>
            ...
            <tbody>
                @foreach ($datas as $data)
                    ...
                    <td class="text-center">
                        ...
                        <a href="{{ route('admin.cod.edit', $data->id) }}" class="btn btn-primary">Edit</a>
