                ...
                <form action="{{ route('admin.notification.teacher') }}" method="GET">
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <div class="input-group-append">
                            ...
                            <a href="{{ route('admin.notification.teacher') }}"class="btn btn-default  ml-2">All
                                Notification</a>
                            <a
                                href="{{ route('admin.notification.teacher', ['seen' => 0]) }}"class="btn btn-success  ml-2">All
                                Unseen Notification</a>
                            <a onclick="disableButton(this)"
                                href="{{ route('admin.notification.teacher', ['seen' => 1]) }}"class="btn btn-secondary  ml-2">All
                                Seen Notification</a>
                        </div>
