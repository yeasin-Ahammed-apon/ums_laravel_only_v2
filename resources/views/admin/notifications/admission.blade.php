    ...
    <div class="card shadow ">
        <div class="card-header">
            ...
            <div class="card-tools">
                <form action="{{ route('admin.notification.admission') }}" method="GET">
                    @csrf
                    <div class="input-group input-group-sm">
                        ...
                        <div class="input-group-append">
                            ...
                            <a href="{{ route('admin.notification.admission') }}"class="btn btn-sm mt-1 mb-1 btn-default  ml-2">All
                                Notification</a>
                            <a
                                href="{{ route('admin.notification.admission', ['seen' => 0]) }}"class="btn btn-sm mt-1 mb-1 btn-success  ml-2">All
                                Unseen Notification</a>
                            <a onclick="disableButton(this)"
                                href="{{ route('admin.notification.admission', ['seen' => 1]) }}"class="btn btn-sm mt-1 mb-1 btn-secondary  ml-2">All
                                Seen Notification</a>
                        </div>
            ...
            <tbody>
                @foreach ($datas as $data)
                    ...
                    <td>
                        ...
                        @else
                            <a href="{{ route('admin.notification.admission', [
                                'id' => $data->id,
                                'type' => 'read',
                            ]) }}"
...
@endsection
@section('scripts')
    @include('parts.multiple_check_js',['multiple_check_url'=>'admin.notification.admission'])
    @include('parts.page_number_set_js',['page_number_url'=>'admin.notification.admission'])
@endsection
