    ...
    <div class="card shadow ">
        <div class="card-header">
            ...
            <div class="card-tools">
                <form action="{{ route('admin.notification.hod') }}" method="GET">
                    @csrf
...
@endsection
@section('scripts')
    @include('parts.multiple_check_js',['multiple_check_url'=>'admin.notification.hod'])
    @include('parts.page_number_set_js',['page_number_url'=>'admin.notification.hod'])
@endsection
