...
@section('content')
    @include('parts.title_start', [
        'title' => $title ?? 'Teacher Edit Form',
        'color' => 'card-warning',
    ])
    <!-- general form elements -->
    <div class="card">
        <form action="{{ route('superAdmin.teacher.update', $data->user_id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body row">
                {{-- role --}}
                <input type="hidden" name="role" value="teacher" class="form-control" placeholder="Enter name">
                {{-- name --}}
