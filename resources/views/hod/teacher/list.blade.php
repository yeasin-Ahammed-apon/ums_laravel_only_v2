                ...
                <form action="{{ route('superAdmin.teacher.index') }}" method="GET">
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <div class="input-group-append">
                            ...
                            <a href="{{ route('superAdmin.teacher.create') }}"class="btn btn-sm mt-1 mb-1 btn-primary  ml-2"><i class="fa fa-plus" aria-hidden="true"></i> Add Teacher</a>
                ...
                @foreach ($datas as $data)
                        ...
                        <td>
                            @if ($data->user->status === 1)
                                <a href="{{ route('superAdmin.teacher.status', $data->user->id) }}" class="btn btn-sm mt-1 mb-1 btn-outline-success"><i class="fa fa-circle" aria-hidden="true"></i>  Active</a>
                            @else
                                <a href="{{ route('superAdmin.teacher.status', $data->user->id) }}" class="btn btn-sm mt-1 mb-1 btn-outline-secondary"><i class="fa fa-circle" aria-hidden="true"></i> Deactive</a>
                            @endif
                        </td>
                        <td class="text-center">
                            <a href="{{ route('superAdmin.teacher.show', $data->id) }}" class="btn btn-sm mt-1 mb-1 btn-success"><i class="fa fa-eye" aria-hidden="true"></i> View</a>
                            <a href="{{ route('superAdmin.teacher.edit', $data->id) }}" class="btn btn-sm mt-1 mb-1 btn-primary"><i class="fa fa-cogs" aria-hidden="true"></i> Edit</a>
