                ...
                <form action="{{ route('hod.notification.cod') }}" method="GET">
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <div class="input-group-append">
                            ...
                            <a href="{{ route('hod.notification.cod') }}"class="btn btn-default  ml-2">All
                                Notification</a>
                            <a
                                href="{{ route('hod.notification.cod', ['seen' => 0]) }}"class="btn btn-success  ml-2">All
                                Unseen Notification</a>
                            <a onclick="disableButton(this)"
                                href="{{ route('hod.notification.cod', ['seen' => 1]) }}"class="btn btn-secondary  ml-2">All
                                Seen Notification</a>
                        </div>
