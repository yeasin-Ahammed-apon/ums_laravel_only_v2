    ...
    <div class="card shadow ">
        <div class="card-header">
            ...
            <div class="card-tools">
                <form action="{{ route(Auth::user()->role->name .'.inventory.item.stock_return_user') }}" method="GET">
                    @csrf
            ...
            <tbody>
                @foreach ($datas as $data)
                    ...
                    <td class="text-center">
                        @if ($data->status)
                        <a href="{{ route(Auth::user()->role->name . '.inventory.item.stock_return', ["id"=>$data->id]) }}"
