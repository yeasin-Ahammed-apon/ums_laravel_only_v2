            ...
            <div class="card-body row">
                ...
                <div class="form-group col-12 col-sm-4">
                    ...
                    <input type="text" value="{{ $data->name }}" name="name"
                        class="form-control @error('name') is-invalid @enderror" placeholder="Enter name" disabled>
                    {!! validationError('name', $errors) !!}
                </div>
                {{-- temporary_id --}}
                <div class="form-group col-12 col-sm-4">
                    <label>temporary_id</label>
                    <input type="text" value="{{ $data->temporary_id }}" name="temporary_id"
                        class="form-control  @error('temporary_id') is-invalid @enderror" placeholder="Enter temporary_id" disabled>
                    {!! validationError('temporary_id', $errors) !!}
                </div>
                {{-- advance_payment --}}
                <div class="form-group col-12 col-sm-4">
                    <label>advance_payment</label>
                    <input type="text" value="{{ $data->advance_payment }}" name="advance_payment"
                        class="form-control  @error('advance_payment') is-invalid @enderror" placeholder="Enter advance_payment" disabled>
                ...
                <div class="form-group col-12 col-sm-4">
                    ...
                    <input type="text" value="{{ $data->father_name }}" name="father_name"
                        class="form-control @error('father_name') is-invalid @enderror" placeholder="Enter father_name">
                ...
                <div class="form-group col-12 col-sm-4">
                    ...
                    <input type="text" value="{{ $data->mother_name }}" name="mother_name"
                        class="form-control @error('mother_name') is-invalid @enderror" placeholder="Enter mother_name">
                ...
                <div class="form-group col-12 col-sm-4">
                    ...
                    <input type="text" value="{{ $data->present_address }}" name="present_address"
                        class="form-control @error('present_address') is-invalid @enderror" placeholder="Enter present_address">
                ...
                <div class="form-group col-12 col-sm-4">
                    ...
                    <input type="text" value="{{ $data->permanent_address }}" name="permanent_address"
                        class="form-control @error('permanent_address') is-invalid @enderror" placeholder="Enter permanent_address">
                ...
                <div class="form-group col-12 col-sm-4">
                    ...
                    <input type="tel" value="{{ $data->emergency_phone }}" name="emergency_phone"
                        class="form-control @error('emergency_phone') is-invalid @enderror" placeholder="Enter emergency_phone">
                ...
                <div class="form-group col-12 col-sm-4">
                    ...
                    <input type="text" value="{{ $data->emergency_phone_name }}" name="emergency_phone_name"
                        class="form-control @error('emergency_phone_name') is-invalid @enderror" placeholder="Enter emergency_phone_name">
                    {!! validationError('emergency_phone_name', $errors) !!}
                </div>
                {{-- blood_group_id --}}
                <div class="form-group col-12 col-sm-4">
                    <label>blood_group</label>
                    <select name="blood_group_id" class="form-control @error('blood_group_id') is-invalid @enderror">
