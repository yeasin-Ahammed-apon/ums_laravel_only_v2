            ...
            <tbody>
                @forelse($rows as $date => $row)
                    <tr>
                        ...
                        @endforeach
                        <td class="text-right">
                            <a href="{{ route('log-viewer::logs.show', [$date]) }}" class="btn btn-sm mt-1 mb-1 btn-xs btn-info">
                                <i class="fa fa-search"></i>
                            </a>
                            <a href="{{ route('log-viewer::logs.download', [$date]) }}" class="btn btn-sm mt-1 mb-1 btn-xs btn-success">
                                <i class="fa fa-download"></i>
                            </a>
                            <a href="#delete-log-modal" class="btn btn-sm mt-1 mb-1 btn-xs btn-danger" data-log-date="{{ $date }}">
